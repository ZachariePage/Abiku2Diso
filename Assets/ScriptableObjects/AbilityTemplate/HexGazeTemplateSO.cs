...
[CreateAssetMenu(menuName = "Abilty/HexGazeTemplate")]
public class HexGazeTemplateSO : AbilityTemplateSO
{
    ...
    {
        return new HexGaze(caster, owner, this, range, targetingStrategy, targetTypeStrategy, numberOfTargets,
